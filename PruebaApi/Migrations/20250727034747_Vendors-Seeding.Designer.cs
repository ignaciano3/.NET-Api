...
namespace PruebaApi.Migrations
{
    ...
    [Migration("20250727034747_Vendors-Seeding")]
    partial class VendorsSeeding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PruebaApi.Models.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "tiamaria123@mail.com",
                            Name = "Tienda Tia Maria",
                            Phone = 1144224422
                        },
                        new
                        {
                            Id = 2,
                            Address = "Azcuenaga 456",
                            CreatedAt = new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "bodegon456@mail.com",
                            Name = "Bodegón Vinos",
                            Phone = 1144556677
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PruebaApi.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductVendor", b =>
                {
                    b.HasOne("PruebaApi.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PruebaApi.Models.Vendor", null)
                        .WithMany()
